...
from clipmind_shared.constants import QUEUE_DEFAULT, QUEUE_SCAN, TASK_SCHEDULED_SCAN_ALL
...
# AAP：beat 定时扫描全部源目录（SCAN_INTERVAL_MINUTES<=0 时不注册调度，beat 空转）
if _settings.scan_interval_minutes > 0:
    celery_app.conf.beat_schedule = {
        "clipmind-scheduled-scan-all": {
            "task": TASK_SCHEDULED_SCAN_ALL,
            "schedule": _settings.scan_interval_minutes * 60.0,
            "options": {"queue": QUEUE_SCAN},
        },
    }
